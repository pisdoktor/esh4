...
return [
    ...
    'sms_bildirim' => [
        ...
        'description' => 'Hasta, yakın ve aile hekimine bilgilendirme SMS gönderimi (yönetici / süper yönetici).',
        'group' => 'site',
        'default' => true,
        'toggleable' => true,
        'routes' => [
    ...
    'stok' => [
        'key' => 'stok',
        'label' => 'Stok takibi',
        'description' => 'Malzeme kartı, stok giriş/çıkış, hasta dağıtımı ve kritik stok uyarıları.',
        'group' => 'site',
        'default' => true,
        'toggleable' => true,
        'routes' => [
    ...
    'rbac' => [
        ...
        'description' => 'Platform personel rolleri ve modül CRUD izinleri (süper yönetici).',
        'group' => 'admin',
        'default' => true,
        'toggleable' => false,
        'routes' => [
