(function () {
    var tbody = document.getElementById('esh-unvan-list-tbody');
    if (!tbody) {
        return;
    }
    ...
    function showError(message) {
        tbody.innerHTML = '<tr class="esh-unvan-list-error-row"><td colspan="7" class="border-0 py-4 text-center text-danger">'
