(function () {
    var tbody = document.getElementById('esh-istek-list-tbody');
    if (!tbody) {
        return;
    }
    ...
    function showError(message) {
        tbody.innerHTML = '<tr class="esh-istek-list-error-row"><td colspan="3" class="border-0 py-4 text-center text-danger">'
