...
class UIHelper {
  ...
  'status' => 'all',
                ...
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0 align-items-lg-center">
                    ...
                    <?php
                    $eshKurumFilterList = (new \App\Models\Kurum())->getList(true);
                    $eshKurumFilterActive = \App\Helpers\TenantContext::sessionKurumFilter();
                    ?>
                    <li class="nav-item d-none d-lg-block me-2 me-lg-3">
                    ...
                    <?php endif; ?>
                    <?php if (AuthHelper::sessionIsAdmin()): ?>
                    <li class="nav-item dropdown position-static me-2 me-lg-3">
                        <a class="nav-link dropdown-toggle bg-warning text-dark rounded-pill px-3 fw-bold shadow-sm" href="#" id="adminDropdown" role="button" data-bs-toggle="dropdown">
                            <i class="fas fa-user-shield me-1"></i> Yönetim
                        </a>
                        <?php AdminNavHelper::renderMegaMenu($currentController, $currentAction); ?>
                    </li>
                    <?php endif; ?>
                    <?php if (AuthHelper::sessionIsSuperAdmin()): ?>
                    <li class="nav-item dropdown position-static me-2 me-lg-3">
                        <a class="nav-link dropdown-toggle bg-danger text-white rounded-pill px-3 fw-bold shadow-sm" href="#" id="superadminDropdown" role="button" data-bs-toggle="dropdown">
                            <i class="fa-solid fa-server me-1"></i> Sistem
                        </a>
                        <?php SuperadminNavHelper::renderMegaMenu($currentController, $currentAction); ?>
                    </li>
                    <?php endif; ?>
