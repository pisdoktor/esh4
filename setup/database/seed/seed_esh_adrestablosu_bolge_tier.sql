-- =============================================================================
-- ESH kurulum seed — Adres ağacı bölge katmanı (seed_esh_adrestablosu.sql sonrası)
-- Eski düz ilçe köklerini «Varsayılan Bölge» altına taşır (tip=bolge).
-- Kaynak: database/migrate_esh_adrestablosu_bolge_tier.sql
-- =============================================================================
