...
CREATE TABLE "esh_hasta_barthel" (
  "id" NUMBER(10) GENERATED BY DEFAULT ON NULL AS IDENTITY NOT NULL,
  "kurum_id" NUMBER(10) DEFAULT 1 NOT NULL,
  "hasta_id" NUMBER(10) NOT NULL,
  "degerlendirme_tarihi" DATE NOT NULL,
  "barbeslenme" NUMBER(3) DEFAULT 0 NOT NULL,
  "barbanyo" NUMBER(3) DEFAULT 0 NOT NULL,
  "barbakim" NUMBER(3) DEFAULT 0 NOT NULL,
  "bargiyinme" NUMBER(3) DEFAULT 0 NOT NULL,
  "barbarsak" NUMBER(3) DEFAULT 0 NOT NULL,
  "barmesane" NUMBER(3) DEFAULT 0 NOT NULL,
  "bartuvalet" NUMBER(3) DEFAULT 0 NOT NULL,
  "bartransfer" NUMBER(3) DEFAULT 0 NOT NULL,
  "barmobilite" NUMBER(3) DEFAULT 0 NOT NULL,
  "barmerdiven" NUMBER(3) DEFAULT 0 NOT NULL,
  "toplam_skor" NUMBER(5) DEFAULT 0 NOT NULL,
  "bagimlilik_duzeyi" VARCHAR2(32) DEFAULT '' NOT NULL,
  "notlar" CLOB DEFAULT NULL,
  "kaydeden_id" NUMBER(10) DEFAULT NULL,
