...
function esh_send_security_headers(): void
{
    ...
    header(
        ...
        . "script-src 'self' 'unsafe-inline' https://api.tomtom.com https://api.mapbox.com https://maps.googleapis.com https://cdn.jsdelivr.net https://cdnjs.cloudflare.com https://code.jquery.com; "
        ...
        . "img-src 'self' data: blob: https://*.tomtom.com https://api.tomtom.com https://*.tiles.mapbox.com https://api.mapbox.com https://maps.gstatic.com https://maps.googleapis.com https://tile.openstreetmap.org https://code.jquery.com; "
        . "font-src 'self' data: https://cdn.jsdelivr.net https://cdnjs.cloudflare.com https://fonts.gstatic.com; "
        . "connect-src 'self' https://api.tomtom.com https://*.tomtom.com https://api.openrouteservice.org https://api.mapbox.com https://*.tiles.mapbox.com https://maps.googleapis.com https://maps.gstatic.com http://127.0.0.1:15873 https://cdn.jsdelivr.net https://cdnjs.cloudflare.com; "
