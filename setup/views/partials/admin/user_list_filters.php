...
if ($r !== 'admin' && $r !== 'staff' && $r !== 'superadmin' && $r !== 'platform_owner') {
    $r = '';
}
        ...
        <div class="card-header bg-white py-3 px-3 px-md-4 border-bottom d-flex flex-wrap align-items-center justify-content-between gap-3">
            <div class="d-flex flex-wrap align-items-center gap-3">
                ...
                <div class="min-w-0">
                    ...
                    <span class="small text-muted">Hesap durumu, yetki<?= \App\Helpers\AuthHelper::sessionIsPlatformOwner() && \App\Helpers\FederationHelper::columnsReady() ? ', bölge/kurum' : '' ?> ve ünvan seçip «Filtrele» ile uygulayın.</span>
                </div>
            </div>
            <button
        ...
        <div id="user-list-filter-collapse" class="collapse<?= $filterExpanded ? ' show' : '' ?>">
            <div class="card-body p-3 p-md-4 bg-body-tertiary bg-opacity-25">
                ...
                <?= esh_form_route_hiddens('User', 'list') ?>
                    ...
                    ?>
                    <?php include ROOT_PATH . '/views/partials/admin/user_list_bolge_filter.php'; ?>
