...
<article class="pha-card">
    ...
    <div class="pha-card__body">
        ...
        <?php if (\App\Helpers\OperationalSettings::isPatientPortalEnabled()): ?>
            <p class="small text-muted text-center mt-4 mb-0">
                Plan ve ziyaret özeti için
                <a href="<?= htmlspecialchars(esh_url('PatientPortal', 'login', [], true), ENT_QUOTES, 'UTF-8') ?>">hasta / bakım veren portalı</a>
            </p>
        <?php endif; ?>
    </div>
</article>
