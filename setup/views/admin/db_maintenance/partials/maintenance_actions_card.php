...
<div class="card shadow-sm border-0" id="bakim">
    ...
    <div class="card-body">
        ...
        <div class="d-flex flex-wrap gap-2 mb-4">
            ...
            <form method="post" action="<?= htmlspecialchars(esh_url('DbMaintenance', 'optimize'), ENT_QUOTES, 'UTF-8') ?>" class="d-inline" data-esh-confirm="Tüm tablolarda OPTIMIZE çalıştırılsın mı? Büyük veritabanlarında uzun sürebilir.">
                <input type="hidden" name="maint_token" value="<?= htmlspecialchars($token, ENT_QUOTES, 'UTF-8') ?>">
        ...
        <form method="post" id="db-maint-selected-form" class="row g-2 align-items-end mb-4">
            ...
            <div class="col-md-4 d-flex flex-wrap gap-2">
                ...
                <button type="submit" formaction="<?= htmlspecialchars(esh_url('DbMaintenance', 'optimizeTable'), ENT_QUOTES, 'UTF-8') ?>" class="btn btn-outline-warning btn-sm" data-esh-confirm="Seçili tablolarda OPTIMIZE çalıştırılsın mı?">OPTIMIZE</button>
            </div>
        </form>
