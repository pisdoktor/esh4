...
<?php if (!empty($clinicalOverdueHighRiskCount)): ?>
<div class="card border-danger border-opacity-50 mt-4 rounded-3">
    <div class="card-body d-flex flex-wrap justify-content-between align-items-center gap-2">
        <div>
            <h6 class="fw-bold text-danger mb-1"><i class="fa-solid fa-user-doctor me-2"></i>Klinik karar desteği</h6>
            <p class="small text-muted mb-0">Son <?= (int) ($clinicalOverdueDays ?? 30) ?> günde izlenmemiş yüksek riskli hasta: <strong><?= (int) $clinicalOverdueHighRiskCount ?></strong></p>
        </div>
        <a href="<?= htmlspecialchars(\App\Helpers\UrlHelper::fromRequestParams(['controller' => 'Stats', 'action' => 'clinicalDecisionSupport']), ENT_QUOTES, 'UTF-8') ?>" class="btn btn-outline-danger btn-sm rounded-pill">Listeyi aç</a>
    </div>
</div>
<?php endif; ?>
