<div class="card border-0 shadow-sm mb-3">
        <div class="card-header bg-white border-bottom py-3 d-flex flex-wrap justify-content-between align-items-center gap-2">
            <h5 class="mb-0 fw-bold">
                <i class="fa-solid fa-users text-primary me-2"></i><?= $labelEsc ?>
                <span class="text-secondary fw-normal">(<?= (int) $total ?> hasta)</span>
            </h5>
            <div class="d-flex align-items-center gap-2 flex-shrink-0">
                <a href="<?= htmlspecialchars(esh_url('Stats', 'dataHealth'), ENT_QUOTES, 'UTF-8') ?>" class="btn btn-sm btn-outline-secondary">Veri sağlığına dön</a>
        ...
        <div class="card-body p-0">
            <div class="table-responsive">
                <table class="table table-sm table-hover mb-0 align-middle">
                    ...
                    <tbody id="esh-data-health-patients-list-tbody"
                           data-esh-fetch-url="<?= htmlspecialchars($dataHealthPatientsRowsFetchUrl ?? '', ENT_QUOTES, 'UTF-8') ?>">
                        <tr class="esh-data-health-patients-list-loading-row">
