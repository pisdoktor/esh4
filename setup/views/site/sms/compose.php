                ...
                <div class="card shadow-sm border-0 h-100">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-2">
                            ...
                            <textarea class="form-control" name="govde" id="sms-govde" rows="8" maxlength="1600" required placeholder="Sayın {{bakimveren_ad}}, {{hasta_ad_soyad}} için {{tarih}} …"><?= htmlspecialchars((string) ($presetGovde ?? ''), ENT_QUOTES, 'UTF-8') ?></textarea>
