                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-sm align-middle">
                            ...
                            <tbody id="esh-nobet-mine-izin-tbody"
                                   data-esh-fetch-url="<?= htmlspecialchars($mineIzinRowsFetchUrl ?? '', ENT_QUOTES, 'UTF-8') ?>">
                                <tr><td colspan="3" class="text-center text-muted py-3 small">Liste yükleniyor…</td></tr>
                            </tbody>
                        </table>
                    </div>
                </div>
            ...
            <div class="card shadow-sm border-0">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-sm align-middle">
                            <thead><tr><th>Tarih</th><th>Açıklama</th><th></th></tr></thead>
                            <tbody id="esh-nobet-mine-istek-tbody"
                                   data-esh-fetch-url="<?= htmlspecialchars($mineIstekRowsFetchUrl ?? '', ENT_QUOTES, 'UTF-8') ?>">
                                <tr><td colspan="3" class="text-center text-muted py-3 small">Liste yükleniyor…</td></tr>
                            </tbody>
                        </table>
                    </div>
