...
<?php endif; ?>
window.ESH_PAGE.fieldVisit = <?= json_encode(\App\Helpers\OperationalSettings::fieldVisitClientConfig(), JSON_UNESCAPED_UNICODE | JSON_HEX_TAG | JSON_HEX_APOS | JSON_HEX_QUOT | JSON_HEX_AMP) ?>;
</script>
