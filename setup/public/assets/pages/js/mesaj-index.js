(function () {
    ...
    function initMailbox() {
        ...
        function loadList() {
            ...
            return eshFetchListHtml(fetchUrl).then(function (data) {
                ...
                inbox.innerHTML = '<div class="list-group-item text-danger text-center py-4">'
                    + escapeHtml(err && err.message ? err.message : 'Liste yüklenemedi.') + '</div>';
            });
