(function () {
    var tbody = document.getElementById('esh-bir-izlemliler-list-tbody');
    if (!tbody) {
        return;
    }
    ...
    function showError(message) {
        tbody.innerHTML = '<tr class="esh-bir-izlemliler-list-error-row"><td colspan="9" class="border-0 py-4 text-center text-danger">'
