(function () {
    var tbody = document.getElementById('esh-islem-list-tbody');
    if (!tbody) {
        return;
    }
    ...
    function showError(message) {
        tbody.innerHTML = '<tr class="esh-islem-list-error-row"><td colspan="3" class="border-0 py-4 text-center text-danger">'
