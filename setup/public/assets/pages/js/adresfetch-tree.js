(function () {
    ...
    function loadTreeRoot() {
        ...
        $root.html('<li class="text-muted small py-2 px-1">Bölgeler yükleniyor…</li>');
        fetchTreeChildren('bolge', '0').done(function (data) {
            if (!data || !data.ok) {
                $root.html('<li class="text-danger small py-2 px-1">Bölgeler yüklenemedi.</li>');
                return;
            }
