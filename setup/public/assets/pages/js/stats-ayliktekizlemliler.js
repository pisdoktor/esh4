(function () {
    var tbody = document.getElementById('esh-aylik-tek-izlemliler-list-tbody');
    if (!tbody) {
        return;
    }
    ...
    function showError(message) {
        tbody.innerHTML = '<tr class="esh-aylik-tek-izlemliler-list-error-row"><td colspan="9" class="border-0 py-4 text-center text-danger">'
