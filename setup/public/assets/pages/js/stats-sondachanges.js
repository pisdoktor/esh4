jQuery(function ($) {
    ...
    var $collapse = $('#stats-sonda-changes-filter-collapse');
    var $toggleText = $('#stats-sonda-changes-filter-toggle .js-filter-toggle-text');
...
(function () {
    var tbody = document.getElementById('esh-sonda-changes-list-tbody');
    if (!tbody) {
        return;
    }
    ...
    function showError(message) {
        tbody.innerHTML = '<tr class="esh-sonda-changes-list-error-row"><td colspan="10" class="border-0 py-4 text-center text-danger">'
