...
class Visit extends BaseModel {
    ...
    /** @var string|null ESYS izlem kayıt no */
    public $esys_izlem_ref = null;
    /** @var string|null ESYS konsültasyon kayıt no */
    public $esys_konsultasyon_ref = null;
    /** @var string|null USBS izlem bildirim no */
    public $usbs_bildirim_ref = null;
    /** @var string|null pending|sent|failed|skipped */
    public $usbs_bildirim_durum = null;
    /** @var string|null Son USBS bildirim zamanı */
    public $usbs_bildirim_at = null;
    /** @var string|null e-Reçete referans no */
    public $erecete_ref = null;
    ...
    /** @var float|null GPS doğruluk (metre) */
    public $checkin_accuracy = null;
