...
final class StatsIntroHelper {
    ...
    private const INTROS = [
        ...
        'clinicalDecisionSupport' => 'Braden, İTAKİ, Harizmi ve MNA skorlarına göre yüksek riskli ve izlenmeyen aktif hastaları listeler.',
        ...
        'barthel' => 'Aktif hastalarda son Barthel değerlendirmesi skor dağılımını gösterir.',
        'braden' => 'Bası yarası işaretli aktif hastalarda son Braden değerlendirmesinin risk dağılımını ve kapsam oranını gösterir.',
        'itaki' => '18 yaş ve üzeri aktif hastalarda son İTAKİ II değerlendirmesinin düşük/yüksek risk dağılımını gösterir.',
        'harizmi' => '0–17 yaş aktif hastalarda son Harizmi II değerlendirmesinin düşük/yüksek risk dağılımını gösterir.',
        'mna' => 'Aktif hastalarda son MNA-SF değerlendirmesinin beslenme durumu dağılımını ve kapsam oranını gösterir.',
