...
class PatientCompletenessHelper
{
    ...
    public static function evaluate(object $patient): array
    {
        ...
        foreach (self::groupDefinitions($profile, $patient) as $groupKey => $groupDef) {
            ...
            $groups[] = [
                ...
                'form_action' => (string) ($groupDef['form_action'] ?? ''),
    ...
    private static function groupDefinitions(string $profile, object $patient): array
    {
        $groups = [
            ...
            'braden' => [
                ...
                'fields' => [
                    [
                        'key' => 'braden_assessment',
                        'label' => 'Braden değerlendirmesi',
            ...
            'itaki' => [
                ...
                'fields' => [
                    [
                        'key' => 'itaki_assessment',
                        'label' => 'İTAKİ değerlendirmesi',
                        'type' => 'clinical_assessment',
                        'assessment' => 'itaki',
                        'when_module' => 'itaki',
                    ],
            ...
            'harizmi' => [
                ...
                'fields' => [
                    [
                        'key' => 'harizmi_assessment',
                        'label' => 'Harizmi değerlendirmesi',
                        'type' => 'clinical_assessment',
                        'assessment' => 'harizmi',
                        'when_module' => 'harizmi',
                    ],
            ...
            'barthel' => [
                ...
                'fields' => [
                    [
                        'key' => 'barthel_assessment',
                        'label' => 'Barthel değerlendirmesi',
                        'type' => 'clinical_assessment',
                        'assessment' => 'barthel',
                        'when_module' => 'barthel',
                    ],
    ...
    {
        if (!empty($fieldDef['when_module']) && !self::isClinicalModuleEnabled($patient, (string) $fieldDef['when_module'])) {
            return false;
        }
    ...
    private static function isFieldFilled(object $patient, array $fieldDef): bool
    {
        ...
        return match ($type) {
            ...
            'clinical_assessment' => self::hasClinicalAssessment($patient, (string) ($fieldDef['assessment'] ?? '')),
    ...
    private static function isClinicalModuleEnabled(object $patient, string $module): bool
    {
        return match ($module) {
            'braden' => PatientClinicalFlagsHelper::isBradenModuleEnabled($patient),
            'itaki' => PatientClinicalFlagsHelper::isItakiModuleEnabled($patient),
            'harizmi' => PatientClinicalFlagsHelper::isHarizmiModuleEnabled($patient),
            'mna' => PatientClinicalFlagsHelper::isMnaModuleEnabled($patient),
            'barthel' => PatientClinicalFlagsHelper::isBarthelModuleEnabled($patient),
            default => false,
        };
    }
    ...
    private static function hasClinicalAssessment(object $patient, string $which): bool
    {
        ...
        $model = match ($which) {
            'braden' => new BradenAssessment(),
            'itaki' => new ItakiAssessment(),
            'harizmi' => new HarizmiAssessment(),
            'mna' => new MnaAssessment(),
            'barthel' => new BarthelAssessment(),
            default => null,
        };
        if ($model === null) {
            return false;
        ...
        return $model->countByHastaId($hastaId) > 0;
    }
}
