...
class StatsNavHelper {
                ...
                'sections' => [
                    ...
                    [
                        ...
                        'cards' => [
                            ...
                            self::card('braden', 'Braden riski', 'Bası yarası risk ölçeği — son değerlendirme dağılımı.', 'fa-kit-medical', 'warning'),
                            self::card('itaki', 'İTAKİ II riski', 'Yetişkin düşme riski — son değerlendirme dağılımı (18+).', 'fa-person-falling', 'danger'),
                            self::card('harizmi', 'Harizmi II riski', 'Pediatrik düşme riski — son değerlendirme dağılımı (0–17).', 'fa-child', 'info'),
                            self::card('mna', 'MNA-SF durumu', 'Mini beslenme değerlendirmesi — son skor dağılımı.', 'fa-utensils', 'success'),
                        ],
                    ],
                    [
                ...
                'sections' => [
                    ...
                    [
                        ...
                        'cards' => [
                            ...
                            self::card('clinicalDecisionSupport', 'Klinik karar desteği', 'Yüksek risk skorları ve izlenmeyen hasta listesi.', 'fa-user-doctor', 'danger'),
                        ],
                    ],
                ],
            ],
    ...
    private const DASHBOARD_QUICK_META = [
        ...
        'clinicalDecisionSupport' => ['title' => 'Klinik karar desteği', 'icon' => 'fa-user-doctor'],
        'barthel' => ['title' => 'Barthel', 'icon' => 'fa-wheelchair'],
        'braden' => ['title' => 'Braden', 'icon' => 'fa-kit-medical'],
        'itaki' => ['title' => 'İTAKİ', 'icon' => 'fa-person-falling'],
        'harizmi' => ['title' => 'Harizmi', 'icon' => 'fa-child'],
        'mna' => ['title' => 'MNA-SF', 'icon' => 'fa-utensils'],
