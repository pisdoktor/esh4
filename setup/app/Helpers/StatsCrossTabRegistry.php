...
final class StatsCrossTabRegistry {
    ...
    private const REPORTS = [
        ...
        'bradenRiskAge' => [
            'title' => 'Braden risk × yaş',
            'desc' => 'Son Braden risk grubu ile yaş bandı.',
            'icon' => 'fa-table',
            'color' => 'warning',
            'hub_group' => 'Hasta Profili ve Dağılım',
            'hub_section' => 'Ölçüm ve kapsam',
            'intro' => 'Satırlar son Braden değerlendirmesine göre risk grupları, sütunlar yaş bantlarıdır. Bası yarası işaretli aktif hastalardan değerlendirmesi olanlar sayılır. Hücreler hasta adedidir.',
            'footnote' => '',
            'period_type' => '',
        ],
        'itakiRiskAge' => [
            'title' => 'İTAKİ × yaş',
            'desc' => 'Son İTAKİ II risk grubu ile yaş bandı.',
            'icon' => 'fa-table',
            'color' => 'danger',
            'hub_group' => 'Hasta Profili ve Dağılım',
            'hub_section' => 'Ölçüm ve kapsam',
            'intro' => 'Satırlar son İTAKİ II değerlendirmesine göre düşük/yüksek risk, sütunlar yaş bantlarıdır. Yalnızca 18 yaş ve üzeri uygun hastalardan değerlendirmesi olanlar sayılır.',
            'footnote' => '',
            'period_type' => '',
        ],
        'harizmiRiskAge' => [
            'title' => 'Harizmi × yaş',
            'desc' => 'Son Harizmi II risk grubu ile yaş bandı.',
            'icon' => 'fa-table',
            'color' => 'info',
            'hub_group' => 'Hasta Profili ve Dağılım',
            'hub_section' => 'Ölçüm ve kapsam',
            'intro' => 'Satırlar son Harizmi II değerlendirmesine göre düşük/yüksek risk, sütunlar yaş bantlarıdır. Yalnızca 0–17 yaş uygun hastalardan değerlendirmesi olanlar sayılır.',
            'footnote' => '',
            'period_type' => '',
        ],
        'mnaStatusAge' => [
            'title' => 'MNA × yaş',
            'desc' => 'Son MNA-SF durum grubu ile yaş bandı.',
            'icon' => 'fa-table',
            'color' => 'success',
            'hub_group' => 'Hasta Profili ve Dağılım',
            'hub_section' => 'Ölçüm ve kapsam',
            'intro' => 'Satırlar son MNA-SF değerlendirmesine göre beslenme durumu grupları, sütunlar yaş bantlarıdır. Değerlendirmesi olan aktif hastalar sayılır.',
            'footnote' => '',
            'period_type' => '',
        ],
        'pansumanVisitGap' => [
