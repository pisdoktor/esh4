 ...
 * Yol: templates/default/site/rota/rota_view.php
 *
 * Controller : DashboardController
 * Action     : showRoute
 * Rota       : Dashboard/showRoute
 * Canonical  : views/site/rota/rota_view.php (bu dosya genelde include eder)
 *
 * Değişkenler (include öncesi controller kapsamı):
 *   $data (array) — tum_vardiya_verisi, merkez, apiKey, tarih_basligi; isteğe bağlı ai_analiz
 *  $_GET['date'] — tarih filtresi (view içinde okunabilir)
 *
