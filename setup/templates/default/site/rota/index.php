 ...
 * Yol: templates/default/site/rota/index.php
 *
 * Controller : (şu an resolveAreaView ile çağrılmıyor)
 * Action     : —
 * Canonical  : views/site/rota/index.php (bu dosya genelde include eder)
 *
 * Değişkenler (include öncesi controller kapsamı):
 *   (legacy; rota için DashboardController::showRoute kullanın)
 *
 * Ortak: $_SESSION['user_id'], SITEURL, ROOT_PATH, UPLOADS_URL (tanımlıysa)
 * Not: Tema kopyası; canlı rota ekranı rota_view.php üzerinden açılır.
 */
?>
<div class="card mb-4 shadow-sm" style="border-top: 4px solid <?php echo $t['color']; ?>;">
