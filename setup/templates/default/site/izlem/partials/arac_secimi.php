 ...
 * Yol: templates/default/site/izlem/partials/arac_secimi.php
 *
 * Controller : VisitController
 * Action     : create | edit
 * Canonical  : views/site/izlem/partials/arac_secimi.php (bu dosya genelde include eder)
 *
 * Değişkenler (include öncesi controller kapsamı):
 *   $araclar (list), $selectedAracId (int), $radiosSuffix (string), $aracPickerAccent (string)
 *
 * Ortak: $_SESSION['user_id'], SITEURL, ROOT_PATH, UPLOADS_URL (tanımlıysa)
 * Not: create.php / edit.php içinden include edilir.
 */
/**
