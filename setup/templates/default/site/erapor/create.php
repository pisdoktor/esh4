 ...
 * Yol: templates/default/site/erapor/create.php
 *
 * Controller : EraporController
 * Action     : create | edit
 * Canonical  : views/site/erapor/create.php (bu dosya genelde include eder)
 *
 * Değişkenler (include öncesi controller kapsamı):
 *   $pageTitle, $branslar; edit’te ayrıca $item (Erapor model)
 *
 * Ortak: $_SESSION['user_id'], SITEURL, ROOT_PATH, UPLOADS_URL (tanımlıysa)
 * Not: create ve edit aynı view dosyasını kullanır.
 */
