 ...
 * Yol: templates/default/site/user/index.php
 *
 * Controller : UserController
 * Action     : index
 * Canonical  : views/site/user/index.php (bu dosya genelde include eder)
 *
 * Değişkenler (include öncesi controller kapsamı):
 *   $user (User) — oturumdaki kullanıcı
 *  $daysWithUs (int)
 *  $profileStatsFetchUrl (string) — istatistik kartları XHR URL
 *
 * Ortak: $_SESSION['user_id'], SITEURL, ROOT_PATH, UPLOADS_URL (tanımlıysa)
 */
?>
<div class="container py-5 esh-page-user-profile">
