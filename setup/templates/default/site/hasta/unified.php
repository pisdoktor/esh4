 ...
 * Yol: templates/default/site/hasta/unified.php
 *
 * Controller : PatientController
 * Action     : unified
 * Rota       : Patient/unified?status=active|passive|waiting|all
 * Canonical  : views/site/hasta/unified.php (bu dosya genelde include eder)
 *
 * Değişkenler (include öncesi controller kapsamı):
 *   $pageTitle, $status, $limit, $page, $search, $reason, $startDate, $endDate
 *  $orderby, $orderdir, $totalPatients (int)
 *  $pasifListesi (array) — pasif neden etiketleri
 *  $baseParams (array), $pagelink (string)
 *  $unifiedRowsFetchUrl (string) — tablo satırları XHR
 *  $showPassiveFilters (bool)
 *
