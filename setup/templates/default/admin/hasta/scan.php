 ...
 * Yol: templates/default/admin/hasta/scan.php
 *
 * Controller : PatientController
 * Action     : scan | scanWaiting
 * Canonical  : views/admin/hasta/scan.php (bu dosya genelde include eder)
 *
 * Değişkenler (include öncesi controller kapsamı):
 *   $scanScope, $scanTitle, $scanInfo, $scanConfirm, $scanAction, $totalCount
 *
