 ...
 * Yol: templates/default/admin/stats/partials/workload_table_rows.php
 *
 * Controller : StatsController
 * Action     : workloadRows (JSON)
 * Rota       : Stats/workloadRows?(JSON)
 * Canonical  : views/admin/stats/partials/workload_table_rows.php (bu dosya genelde include eder)
 *
