 ...
 * Yol: templates/default/admin/stats/partials/special_devices_table_rows.php
 *
 * Controller : StatsController
 * Action     : specialDevicesRows (JSON)
 * Rota       : Stats/specialDevicesRows?(JSON)
 * Canonical  : views/admin/stats/partials/special_devices_table_rows.php (bu dosya genelde include eder)
 *
