 ...
 * Yol: templates/default/admin/stats/partials/randevu_kayit_gap_section.php
 *
 * Controller : StatsController
 * Action     : —
 * Rota       : index.php?controller=Stats&action=—
 * Canonical  : views/admin/stats/partials/randevu_kayit_gap_section.php (bu dosya genelde include eder)
 *
 ...
 *  $report — randevu_kayit_gap.php içinden include
 *
...
<div class="card shadow-sm border-0">
    <div class="card-header bg-white py-3 border-bottom">
        <h5 class="mb-0 fw-bold">
            <i class="fa-solid <?= htmlspecialchars($sectionIcon, ENT_QUOTES, 'UTF-8') ?> text-secondary me-2"></i>
