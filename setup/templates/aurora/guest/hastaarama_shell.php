...
$__loginUrl = htmlspecialchars($__base . '?controller=Auth&action=login', ENT_QUOTES, 'UTF-8');
...
<head>
    ...
    <link rel="stylesheet" href="<?= htmlspecialchars($__assets . '/global.css', ENT_QUOTES, 'UTF-8'); ?>">
    <link rel="stylesheet" href="<?= htmlspecialchars($__assets . '/pages/css/public-hastaarama.css', ENT_QUOTES, 'UTF-8'); ?>">
<?php foreach (\App\Helpers\ThemeViewHelper::themeStylesheetSlugStack($__lt) as $__thSlug): $__thUrl = \App\Helpers\ThemeViewHelper::themeStylesheetUrl($__thSlug); if ($__thUrl): ?>
    <link rel="stylesheet" href="<?= htmlspecialchars($__thUrl, ENT_QUOTES, 'UTF-8'); ?>">
<?php endif; endforeach; unset($__thSlug, $__thUrl); ?>
</head>
