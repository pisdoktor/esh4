<div class="au-panel p-3 esh-page-rota au-page-rota planning-wrapper">
                    ...
                    <div class="row g-3">
                        <?php foreach($data['tum_vardiya_verisi'][$key] as $eID => $eData): ?>
                            <div class="col-xl-6 col-lg-12">
                                <?php include \App\Helpers\ThemeViewHelper::resolveAreaView('site', 'rota/ekip_karti'); ?>
                            </div>
                        <?php endforeach; ?>
                    </div>
                <?php endif; ?>
