...
?>
<div class="au-panel mb-4 overflow-hidden esh-stats-date-filter">
    <div class="au-panel__head au-panel__head--split">
        <div class="d-flex flex-wrap align-items-center gap-3">
            <span class="au-icon-chip au-icon-chip--soft flex-shrink-0"><i class="fa-solid fa-sliders"></i></span>
            <div class="min-w-0">
    ...
    <div id="<?= htmlspecialchars($collapseId, ENT_QUOTES, 'UTF-8') ?>" class="collapse<?= $filterExpanded ? ' show' : '' ?>">
        <div class="au-panel__body bg-body-tertiary bg-opacity-25">
