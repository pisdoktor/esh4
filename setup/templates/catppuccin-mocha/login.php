<?php
/**
 * Catppuccin Mocha — oturum açma (`active_theme` / site varsayılanı `catppuccin-mocha` iken).
 * `ThemeViewHelper::resolveLoginView()` bu dosyayı seçer.
 */
$__lt = 'catppuccin-mocha';
?>
<!DOCTYPE html>
...
<head>
    ...
    <title><?= htmlspecialchars(esh_app_name(), ENT_QUOTES, 'UTF-8'); ?> v<?= htmlspecialchars(esh_app_version(), ENT_QUOTES, 'UTF-8'); ?> | Oturum aç · Catppuccin</title>
...
<body class="page-login page-login-theme-catppuccin-mocha theme-meridian theme-catppuccin-mocha mr-login-page min-vh-100">
                    ...
                    <div class="row g-0">
                        <aside class="col-lg-5 mr-login-brand d-none d-lg-flex flex-column justify-content-between p-4 p-xl-5 text-white" aria-label="Uygulama markası">
                            <div>
                                ...
                                <p class="mr-login-kicker text-uppercase small fw-semibold mb-2">Catppuccin · Mocha</p>
