<article class="ev-sheet mr-page mr-admin-page mr-admin-shell container-fluid mt-0 py-4" lang="tr"><header class="visually-hidden"><h1>Yönetim</h1></header>
    <div class="card shadow-sm border-0">
        <div class="card-header bg-dark  d-flex justify-content-between align-items-center">
            <h5 class="mb-0"><i class="fa-solid fa-microchip me-2"></i><?= htmlspecialchars($scanTitle ?? 'MERNIS Toplu Vefat Taramasi') ?></h5>
...
window.ESH_PAGE.scanConfirm = <?= json_encode((string) ($scanConfirm ?? 'Tarama baslatilsin mi?'), JSON_UNESCAPED_UNICODE | JSON_HEX_TAG | JSON_HEX_APOS | JSON_HEX_QUOT | JSON_HEX_AMP) ?>;
