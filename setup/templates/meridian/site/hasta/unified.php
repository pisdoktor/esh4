...
<article class="mr-page mr-page--patient-unified container-fluid py-4 esh-page-patient-unified<?= $curStatus === 'waiting' ? ' esh-unified-status-waiting' : '' ?>" lang="tr">
<header class="visually-hidden"><h1>Hasta listesi</h1></header>
