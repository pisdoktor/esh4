<article class="mr-page mr-page--hasta-wounds" lang="tr">
<header class="visually-hidden"><h1>Hasta yara fotoğrafları</h1></header>
<?php
/**
...
<div class="container-lg py-4 esh-page-patient-wounds">
    ...
    <div class="card shadow-sm border-0 border-top border-danger border-4">
        <div class="card-body p-3 p-md-4">
            <?php include __DIR__ . '/partials/wound_photos_gallery.php'; ?>
            <?php include __DIR__ . '/partials/wound_photos_upload.php'; ?>
        </div>
    </div>
</div>

<?php include __DIR__ . '/partials/wound_photo_modal.php'; ?>
</article>
