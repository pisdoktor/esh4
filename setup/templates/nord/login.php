<?php
/**
 * Nord — oturum açma (`active_theme` => `nord`).
 */
$__lt = 'nord';
?>
<!DOCTYPE html>
...
<head>
    ...
    <title><?= htmlspecialchars(esh_app_name(), ENT_QUOTES, 'UTF-8'); ?> v<?= htmlspecialchars(esh_app_version(), ENT_QUOTES, 'UTF-8'); ?> | Oturum aç · Nord</title>
...
<body class="page-login page-login-theme-nord theme-meridian theme-nord mr-login-page min-vh-100">
                    ...
                    <div class="row g-0">
                        <aside class="col-lg-5 mr-login-brand d-none d-lg-flex flex-column justify-content-between p-4 p-xl-5 text-white" aria-label="Uygulama markası">
                            <div>
                                ...
                                <p class="mr-login-kicker text-uppercase small fw-semibold mb-2">Nord</p>
