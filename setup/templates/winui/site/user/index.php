<div class="fluent-page fluent-user fluent-user-index container py-5 esh-page-user-profile">
    <div class="row justify-content-center">
        <div class="col-12 col-xl-11 col-xxl-10">
            <div class="card fluent-layer-card fluent-hover-tilt shadow-sm border-0 rounded-4 overflow-hidden">
                <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center border-bottom">
                    <h5 class="mb-0 fw-bold text-primary fluent-page-title">
                ...
                <div class="card-body py-4 px-3 px-md-4">
                    <div class="row g-4 g-lg-5 align-items-start">
                        <div class="col-lg-5 text-center text-lg-start">
                            <?php include ROOT_PATH . '/views/site/user/partials/profile_avatar.php'; ?>
