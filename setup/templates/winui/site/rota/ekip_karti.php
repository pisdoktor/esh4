...
?>
<div class="card fluent-rota fluent-rota-ekip-card fluent-layer-card fluent-hover-tilt mb-4 shadow-sm" style="border-top: 4px solid <?= $__ekipKartiRenk ?>;">
                    ...
                    <tr <?php if($h->oncelik == 2) echo 'class="table-danger" style="--bs-table-bg: #fff5f5;"'; ?>>
                        ...
                        <td class="px-3" style="min-width: 150px;">
                            ...
                            <div class="text-muted small">
                                <?php require ROOT_PATH . '/views/site/rota/partials/mahalle_bolge.php'; ?>
                            </div>
                        </td>
