...
?>
<div class="fluent-page fluent-izlem fluent-izlem-edit container-lg py-4 izlem-form-page">
    <div class="card fluent-layer-card fluent-hover-tilt border-0 shadow rounded-3 overflow-hidden">
        <div class="card-header bg-primary text-white py-3 px-4 d-flex flex-wrap justify-content-between align-items-center gap-2 border-0">
            <div>
                <h5 class="mb-0 fw-bold fluent-page-title"><i class="fa-solid fa-pen-to-square me-2"></i>İzlem kaydını düzenle</h5>
                <p class="small mb-0 mt-1 opacity-90 fluent-subtitle">Bilgileri güncelleyip kaydedin.</p>
            </div>
                        ...
                        <div class="izlem-form-panel h-100 rounded-3 border bg-white p-3 p-md-4 shadow-sm">
                            ...
                            <div class="vstack gap-4">
                                ...
                                <div>
                                    ...
                                    <textarea name="aciklama" class="form-control shadow-sm" rows="4" placeholder="Ek notlar, ölçüm veya özel durum…"><?= htmlspecialchars((string) ($visit->aciklama ?? ''), ENT_QUOTES, 'UTF-8') ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
