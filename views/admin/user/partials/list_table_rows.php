    ...
    foreach ($items as $item): ?>
        <tr>
            ...
            <td class="text-center">
                <?php
                $eshRoleLevel = max(0, min(2, (int) ($item->isadmin ?? 0)));
                $eshRoleClass = \App\Helpers\AuthHelper::adminLevelBadgeClass($eshRoleLevel);
                ?>
                <span class="badge <?= htmlspecialchars($eshRoleClass, ENT_QUOTES, 'UTF-8') ?> px-3"><?= htmlspecialchars(\App\Helpers\AuthHelper::adminLevelLabel($eshRoleLevel), ENT_QUOTES, 'UTF-8') ?></span>
            </td>
            <td class="text-center">
            ...
            <td class="text-end pe-4">
                <?php $eshCanManageRow = \App\Helpers\AuthHelper::canManageUser((int) ($item->id ?? 0)); ?>
                <div class="btn-group">
