            <div class="alert alert-info py-2 small mb-3">
                Koordinatsız kapı kayıtları <strong>tek tek</strong> işlenir: ilçe → mahalle → sokak → kapı hiyerarşisinden adres metni oluşturulur, TomTom Geocode API ile sorgulanır, sonuç <code>esh_adrestablosu.coords</code> alanına yazılır.
