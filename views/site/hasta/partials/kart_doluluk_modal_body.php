...
<div class="esh-hasta-doluluk__groups esh-hasta-doluluk__groups--modal">
    <?php foreach ($groups as $group):
        ...
        $formAction = (string) ($group['form_action'] ?? '');
    ...
    <div class="esh-hasta-doluluk__group mb-2">
        <div class="d-flex justify-content-between align-items-center small mb-1">
            ...
            <span class="text-muted">
                ...
                <?php elseif ($formAction !== '' && $missing !== [] && $hastaId > 0): ?>
                <a href="<?= htmlspecialchars(esh_url('Patient', $formAction, ['id' => $hastaId]), ENT_QUOTES, 'UTF-8') ?>"
                   class="btn btn-link btn-sm p-0 ms-1 align-baseline"
                   title="Değerlendirme formunu aç">
