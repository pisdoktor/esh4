<?php
/**
 * Barthel değerlendirme geçmişi tablosu.
 *
 * @var object $hasta
...
<?php if ($rows === []): ?>
    <div class="p-4 text-center text-muted">
        ...
        <p class="mb-0 small">Henüz Barthel değerlendirmesi kaydedilmemiş.</p>
    </div>
<?php else: ?>
    <div class="table-responsive">
        <table class="table table-sm table-hover align-middle mb-0">
            <thead class="table-light">
                <tr>
                    <th>Tarih</th>
                    <?php foreach (BarthelScaleHelper::SCORE_KEYS as $fk): ?>
            ...
            <tbody>
                <?php foreach ($rows as $row): ?>
                    ...
                    $statusMeta = BarthelScaleHelper::resolveDependencyLevel($total);
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="badge <?= htmlspecialchars((string) $statusMeta['badgeClass'], ENT_QUOTES, 'UTF-8') ?>">
                                <?= htmlspecialchars((string) ($row->bagimlilik_duzeyi ?? $statusMeta['label']), ENT_QUOTES, 'UTF-8') ?>
                            </span>
                        </td>
                    ...
                    <?php if (!empty($row->notlar)): ?>
                        <tr class="table-light">
                            <td colspan="15" class="small text-muted py-1 ps-3">
