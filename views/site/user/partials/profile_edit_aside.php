...
<aside class="esh-profile-edit-aside" aria-label="Profil özeti">
    <div class="card border-0 shadow-sm rounded-4 overflow-hidden h-100 esh-profile-edit-aside__card">
        <div class="card-body p-4 text-center text-lg-start">
            ...
            include __DIR__ . '/profile_avatar.php';
            ...
            <ul class="list-unstyled small text-start mb-4 esh-profile-edit-aside__facts">
                ...
                <li class="d-flex justify-content-between gap-2 py-2 border-bottom border-light-subtle">
                    <span class="text-secondary"><i class="fa-solid fa-building me-2 opacity-75" aria-hidden="true"></i>Kurum</span>
                    <span class="fw-semibold text-end"><?= htmlspecialchars($eshKurumLabel, ENT_QUOTES, 'UTF-8') ?></span>
                </li>
                <li class="d-flex justify-content-between gap-2 py-2 border-bottom border-light-subtle">
