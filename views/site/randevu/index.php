 ...
 * @var array<int, array<string, mixed>> $bransKotaMap brans_id => kota özeti
 * @var array<int,object> $istekler esh_istekler listesi
 */
$bransKotaMap = $bransKotaMap ?? [];
$istekler = $istekler ?? [];

$eshAppointmentCalController = 'Randevu';
$eshAppointmentCalAction = 'index';
include ROOT_PATH . '/views/site/partials/appointment_calendar_bootstrap.php';
?>
<div class="container-fluid px-3 px-md-4 px-xl-5 py-4 esh-page-randevu">
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3">
        <div>
            <h1 class="h3 fw-bold mb-0"><i class="fa-solid fa-calendar-days text-primary me-2"></i>Branş randevu takvimi</h1>
