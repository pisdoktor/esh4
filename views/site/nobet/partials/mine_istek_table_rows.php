...
<?php else:
    ...
    <tr>
        ...
        <td class="text-end">
            <form method="post" action="<?= htmlspecialchars(esh_url('Nobet', 'deleteMineIstek'), ENT_QUOTES, 'UTF-8') ?>" class="d-inline m-0" onsubmit="return confirm('Silinsin mi?')">
