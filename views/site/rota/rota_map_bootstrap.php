...
/** Rota haritası bootstrap — TomTom proxy uç noktaları; anahtar HTML'e gömülmez. */
?>
<script>
...
window.ESH_PAGE.showRoute = {
    ...
    routeUrl: <?= json_encode(esh_url('Dashboard', 'tomtomRouteAjax'), JSON_HEX_TAG | JSON_HEX_APOS | JSON_HEX_QUOT) ?>,
