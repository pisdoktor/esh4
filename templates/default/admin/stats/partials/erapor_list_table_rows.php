 ...
 * Yol: templates/default/admin/stats/partials/erapor_list_table_rows.php
 *
 * Controller : StatsController
 * Action     : eraporListRows (JSON)
 * Rota       : Stats/eraporListRows?(JSON)
 * Canonical  : views/admin/stats/partials/erapor_list_table_rows.php (bu dosya genelde include eder)
 *
