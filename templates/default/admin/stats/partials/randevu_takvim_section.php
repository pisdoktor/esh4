 ...
 * Yol: templates/default/admin/stats/partials/randevu_takvim_section.php
 *
 * Controller : StatsController
 * Action     : —
 * Rota       : index.php?controller=Stats&action=—
 * Canonical  : views/admin/stats/partials/randevu_takvim_section.php (bu dosya genelde include eder)
 *
 ...
 *  $report, $sectionTitle — randevu_takvim.php içinden include
 *
