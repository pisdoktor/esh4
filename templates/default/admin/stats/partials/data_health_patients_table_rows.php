 ...
 * Yol: templates/default/admin/stats/partials/data_health_patients_table_rows.php
 *
 * Controller : StatsController
 * Action     : dataHealthPatientsRows (JSON)
 * Rota       : Stats/dataHealthPatientsRows?(JSON)
 * Canonical  : views/admin/stats/partials/data_health_patients_table_rows.php (bu dosya genelde include eder)
 *
