 ...
 * Yol: templates/default/admin/stats/partials/data_health_content.php
 *
 * Controller : StatsController
 * Action     : dataHealthContent (JSON)
 * Rota       : Stats/dataHealthContent?(JSON)
 * Canonical  : views/admin/stats/partials/data_health_content.php (bu dosya genelde include eder)
 *
 ...
 * Not: data_health.php kart içeriği.
 */
/**
