 ...
 * Yol: templates/default/partials/footer.php
 *
 * Controller : (tüm footer kullanan aksiyonlar)
 * Action     : —
 * Canonical  : views/partials/footer.php (bu dosya genelde include eder)
 *
 * Değişkenler (include öncesi controller kapsamı):
 *   (özel değişken yok; üstteki sayfa kapsamı geçerlidir)
 *
