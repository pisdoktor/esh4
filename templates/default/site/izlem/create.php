 ...
 * Yol: templates/default/site/izlem/create.php
 *
 * Controller : VisitController
 * Action     : create
 * Canonical  : views/site/izlem/create.php (bu dosya genelde include eder)
 *
 * Değişkenler (include öncesi controller kapsamı):
 *   $patient, $plan (object|null), $islemler, $personel, $preYapilan
 *  $defaultIzlemDate, $defaultZaman, $todayYmd
 *  $list (array: islem, personel HTML), $araclar, $selectedAracId
 *  Partial: partials/arac_secimi.php
 *
