<div class="fluent-page fluent-izlem fluent-izlem-create container-lg py-4 izlem-form-page">
    <div class="card fluent-layer-card fluent-hover-tilt border-0 shadow rounded-3 overflow-hidden">
        <div class="card-header bg-success text-white py-3 px-4 d-flex flex-wrap justify-content-between align-items-center gap-2 border-0">
            <div>
                <h5 class="mb-0 fw-bold fluent-page-title"><i class="fa-solid fa-notes-medical me-2"></i>Yeni izlem kaydı</h5>
                <p class="small mb-0 mt-1 opacity-90 fluent-subtitle">Hasta için yapılan veya planlanan izlem bilgisini girin.</p>
            </div>
                        ...
                        <div class="izlem-form-panel h-100 rounded-3 border bg-light-subtle p-3 p-md-4 shadow-sm">
                            ...
                            <div class="vstack gap-4">
                                ...
                                <div>
                                    ...
                                    <?= \App\Helpers\UIHelper::zamanDilimiRadios('zaman', 'izlem-create', (int) ($defaultZaman ?? 0)) ?>
                                </div>
                                <div>
                        ...
                        <div class="izlem-form-panel h-100 rounded-3 border bg-white p-3 p-md-4 shadow-sm">
                            ...
                            <div class="vstack gap-4">
                                ...
                                <div>
                                    ...
                                    <textarea name="aciklama" class="form-control shadow-sm" rows="4" placeholder="Ek notlar, ölçüm veya özel durum…"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
