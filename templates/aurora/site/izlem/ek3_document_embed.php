...
<div class="esh-ek3-embed-toolbar d-flex flex-wrap align-items-center gap-2 px-3 py-2 border-bottom bg-light small">
    ...
    <div class="d-flex flex-wrap gap-2 ms-auto">
        <button type="button" class="btn btn-warning btn-sm" data-esh-pdfmake="print">
            <i class="fa-solid fa-print me-1"></i>Yazdır
        </button>
        <button type="button" class="btn btn-info btn-sm" data-esh-pdfmake="download" data-esh-pdfmake-filename="<?= $ek3DlName ?>-EK3.pdf">
