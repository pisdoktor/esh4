...
?>
<div class="au-panel au-ekip-karti mb-4" style="border-top: 4px solid <?= $__ekipKartiRenk ?>;">
                        ...
                        <tr <?php if($h->oncelik == 2) echo 'class="table-danger" style="--bs-table-bg: #fff5f5;"'; ?>>
                            ...
                            <td class="px-3" style="min-width: 150px;">
                                ...
                                <div class="text-muted small">
                                    <?php require \App\Helpers\ThemeViewHelper::resolveAreaView('site', 'rota/partials/mahalle_bolge'); ?>
                                </div>
                            </td>
