...
?>
<div class="container py-4 esh-page-user-stats-hub au-page-stats-hub">
    ...
    <?php foreach ($hubGroups as $group): ?>
        <div class="au-panel mb-4">
            <div class="au-panel__head">
                <span class="au-icon-chip au-icon-chip--soft"><i class="<?= htmlspecialchars((string) $group['icon'], ENT_QUOTES, 'UTF-8') ?>"></i></span>
                <h2 class="au-panel__title mb-0">
