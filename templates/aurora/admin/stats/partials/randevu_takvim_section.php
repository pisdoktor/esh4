...
?>
<div class="au-panel h-100">
    <div class="au-panel__head au-panel__head--split">
        <div class="d-flex align-items-center gap-2">
            <span class="au-icon-chip au-icon-chip--soft"><i class="fa-solid <?= htmlspecialchars($sectionIcon, ENT_QUOTES, 'UTF-8') ?>"></i></span>
            <h2 class="au-panel__title mb-0"><?= htmlspecialchars($sectionTitle, ENT_QUOTES, 'UTF-8') ?></h2>
        </div>
