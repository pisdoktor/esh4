<?php
/**
 * Catppuccin Latte — oturum açma (`active_theme` => `catppuccin-latte`).
 */
$__lt = 'catppuccin-latte';
?>
<!DOCTYPE html>
...
<head>
    ...
    <title><?= htmlspecialchars(esh_app_name(), ENT_QUOTES, 'UTF-8'); ?> v<?= htmlspecialchars(esh_app_version(), ENT_QUOTES, 'UTF-8'); ?> | Oturum aç · Latte</title>
...
<body class="page-login page-login-theme-catppuccin-latte theme-meridian theme-catppuccin-latte mr-login-page min-vh-100">
                    ...
                    <div class="row g-0">
                        <aside class="col-lg-5 mr-login-brand d-none d-lg-flex flex-column justify-content-between p-4 p-xl-5 text-white" aria-label="Uygulama markası">
                            <div>
                                ...
                                <p class="mr-login-kicker text-uppercase small fw-semibold mb-2">Catppuccin · Latte</p>
