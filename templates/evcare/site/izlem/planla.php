<article class="ev-sheet mr-page mr-page--izlem-plan-create container-fluid px-3 px-lg-4 py-4 izlem-plan-page izlem-plan-create-page" lang="tr">
<header class="visually-hidden"><h1>Yeni izlem planla</h1></header>
<section class="ev-izlem-banner mb-3" aria-labelledby="ev-izlem-plan-banner-title">
    <div class="ev-izlem-banner__inner">
        <span class="ev-izlem-banner__mark" aria-hidden="true"><i class="fa-solid fa-calendar-plus"></i></span>
        <div>
            <p class="ev-izlem-banner__eyebrow mb-1">Planlama</p>
            <h2 id="ev-izlem-plan-banner-title" class="ev-izlem-banner__title mb-0">Yeni izlem planla</h2>
            <p class="ev-izlem-banner__hint small mb-0">Tarih, öncelik, tekrar ve yapılacak işlemleri belirleyin.</p>
        </div>
        <a href="<?= htmlspecialchars(esh_url('Visit', 'history', ['tc' => urlencode((string) ($patient->tckimlik ?? ''))]), ENT_QUOTES, "UTF-8") ?>" class="btn btn-sm btn-outline-primary rounded-pill ms-auto align-self-start">
            <i class="fa-solid fa-notes-medical me-1"></i>İzlem geçmişi
        </a>
    </div>
</section>
    <div class="card border-0 shadow rounded-4 overflow-hidden izlem-plan-create-card ev-izlem-plan-create-card">
