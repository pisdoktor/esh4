<article class="ev-sheet mr-page mr-page--rota" lang="tr">
<header class="visually-hidden"><h1>Rota planlaması</h1></header>
<section class="ev-rota-hero mb-3" aria-labelledby="ev-rota-hero-title">
    <div class="ev-rota-hero__stripe" aria-hidden="true"></div>
    <div class="ev-rota-hero__text">
        <p class="ev-rota-hero__eyebrow mb-1">Saha</p>
        <h2 id="ev-rota-hero-title" class="ev-rota-hero__title mb-0">Rota planlaması</h2>
        <p class="ev-rota-hero__lead small mb-0">Tarih seçin; ekip ve mahalle akışını takip edin.</p>
    </div>
</section>
<div class="planning-wrapper bg-white p-3 border rounded-4 shadow-sm esh-page-rota ev-rota-planning-wrap">
...
<?php if (!empty($data['ai_analiz'])): ?>
    <section class="rota-ai-analiz mb-4" aria-labelledby="rota-ai-heading">
    <div class="alert alert-secondary border-0 shadow-sm mb-0">
        <h5 id="rota-ai-heading" class="fw-bold text-dark mb-3">
...
<section class="rota-harita-wrap mt-4" aria-label="Rota haritası">
